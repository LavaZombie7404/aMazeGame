...
export interface Skin {
  ...
  /** Paint the entire canvas background before any maze content. */
  drawBackground(ctx: CanvasRenderingContext2D, m: SkinMetrics): void;
   ...
   * from the maze, so repeated frames produce identical wall jitter.
   */
  drawWall(
